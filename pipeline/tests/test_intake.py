...
def test_heic_is_still_ignored_client_must_convert_first(tmp_path, name):
    """HEIC never reaches the pipeline — the client (Shortcut/PWA) always
    converts to JPEG first (CLAUDE.md §7: no Pillow, no server HEIC decode)."""
